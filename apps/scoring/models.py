...
class HardFilterResult(models.Model):
    ...
    mortality_within_norm = models.BooleanField('Падёж в норме', default=False)
    pasture_load_valid = models.BooleanField('Нагрузка на пастбище', default=False)
    pedigree_valid = models.BooleanField('Племенное свидетельство', default=False)
