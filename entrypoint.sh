...
echo ""
echo "Farmers:"
echo "  bereke      / demo123  - СПК Береке Астана (880720300456)"
echo "  zhumabaev   / demo123  - КХ Жумабаев Н. (901105200789)"
echo "  tastemirova  / demo123  - ИП Тастемирова А. (920812500567)"
echo "  abramova    / demo123  - ИП Абрамова С. (950315400123)"
echo "  dala_agro   / demo123  - ТОО Дала Агро (850930100234)"
echo "  ospanov     / demo123  - КХ Оспанов (870325100890)"
echo ""
echo "Staff:"
echo "  specialist  / demo123  - Специалист МИО"
echo "  commission  / demo123  - Член комиссии"
echo "  head        / demo123  - Руководитель МИО"
echo "  admin       / demo123  - Администратор"
echo "  auditor     / demo123  - Аудитор"
echo ""
